...
class PC(db.Model):
    ...
    snapshots = db.relationship('SystemSnapshot', backref='pc', lazy='dynamic',
                                cascade='all, delete-orphan')
    software = db.relationship('Software', backref='pc', lazy='dynamic',
                               cascade='all, delete-orphan')
    updates = db.relationship('WindowsUpdate', backref='pc', lazy='dynamic',
                              cascade='all, delete-orphan')
    tasks = db.relationship('Task', backref='pc', lazy='dynamic',
                            cascade='all, delete-orphan')
    event_logs = db.relationship('EventLog', backref='pc', lazy='dynamic',
                                 cascade='all, delete-orphan')
